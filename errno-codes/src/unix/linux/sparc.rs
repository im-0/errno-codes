...
pub const EINPROGRESS: std::os::raw::c_int = 36;
...
pub const EALREADY: std::os::raw::c_int = 37;
...
pub const ENOTSOCK: std::os::raw::c_int = 38;
...
pub const EDESTADDRREQ: std::os::raw::c_int = 39;
...
/// Message too long.
pub const EMSGSIZE: std::os::raw::c_int = 40;
...
pub const EPROTOTYPE: std::os::raw::c_int = 41;
...
pub const ENOPROTOOPT: std::os::raw::c_int = 42;
...
pub const EPROTONOSUPPORT: std::os::raw::c_int = 43;
...
pub const ESOCKTNOSUPPORT: std::os::raw::c_int = 44;
...
pub const EOPNOTSUPP: std::os::raw::c_int = 45;
/// Human-readable message for EOPNOTSUPP.
pub const EOPNOTSUPP_MSG: &str = "Op not supported on transport endpoint";
/// Identifier for EOPNOTSUPP as a string (equals to "EOPNOTSUPP").
pub const EOPNOTSUPP_ID: &str = "EOPNOTSUPP";

/// Protocol family not supported.
pub const EPFNOSUPPORT: std::os::raw::c_int = 46;
...
pub const EAFNOSUPPORT: std::os::raw::c_int = 47;
...
pub const EADDRINUSE: std::os::raw::c_int = 48;
...
pub const EADDRNOTAVAIL: std::os::raw::c_int = 49;
...
/// Network is down.
pub const ENETDOWN: std::os::raw::c_int = 50;
...
pub const ENETUNREACH: std::os::raw::c_int = 51;
...
pub const ENETRESET: std::os::raw::c_int = 52;
/// Human-readable message for ENETRESET.
pub const ENETRESET_MSG: &str = "Net dropped connection because of reset";
/// Identifier for ENETRESET as a string (equals to "ENETRESET").
pub const ENETRESET_ID: &str = "ENETRESET";

/// Software caused connection abort.
pub const ECONNABORTED: std::os::raw::c_int = 53;
...
pub const ECONNRESET: std::os::raw::c_int = 54;
...
pub const ENOBUFS: std::os::raw::c_int = 55;
...
pub const EISCONN: std::os::raw::c_int = 56;
...
pub const ENOTCONN: std::os::raw::c_int = 57;
...
pub const ESHUTDOWN: std::os::raw::c_int = 58;
/// Human-readable message for ESHUTDOWN.
pub const ESHUTDOWN_MSG: &str = "No send after transport endpoint shutdown";
/// Identifier for ESHUTDOWN as a string (equals to "ESHUTDOWN").
pub const ESHUTDOWN_ID: &str = "ESHUTDOWN";

/// Too many references: cannot splice.
pub const ETOOMANYREFS: std::os::raw::c_int = 59;
...
pub const ETIMEDOUT: std::os::raw::c_int = 60;
...
/// Connection refused.
pub const ECONNREFUSED: std::os::raw::c_int = 61;
...
pub const ELOOP: std::os::raw::c_int = 62;
...
/// File name too long.
pub const ENAMETOOLONG: std::os::raw::c_int = 63;
...
/// Host is down.
pub const EHOSTDOWN: std::os::raw::c_int = 64;
...
/// No route to host.
pub const EHOSTUNREACH: std::os::raw::c_int = 65;
...
/// Directory not empty.
pub const ENOTEMPTY: std::os::raw::c_int = 66;
...
pub const EPROCLIM: std::os::raw::c_int = 67;
/// Human-readable message for EPROCLIM.
pub const EPROCLIM_MSG: &str = "SUNOS: Too many processes";
/// Identifier for EPROCLIM as a string (equals to "EPROCLIM").
pub const EPROCLIM_ID: &str = "EPROCLIM";
...
/// Device not a stream.
pub const ENOSTR: std::os::raw::c_int = 72;
...
/// Timer expired.
pub const ETIME: std::os::raw::c_int = 73;
...
pub const ENOSR: std::os::raw::c_int = 74;
...
pub const ENOMSG: std::os::raw::c_int = 75;
...
/// Not a data message.
pub const EBADMSG: std::os::raw::c_int = 76;
...
/// Identifier removed.
pub const EIDRM: std::os::raw::c_int = 77;
...
pub const EDEADLK: std::os::raw::c_int = 78;
...
pub const ENOLCK: std::os::raw::c_int = 79;
...
pub const ENONET: std::os::raw::c_int = 80;
...
pub const ERREMOTE: std::os::raw::c_int = 81;
/// Human-readable message for ERREMOTE.
pub const ERREMOTE_MSG: &str = "SunOS: Too many lvls of remote in path";
/// Identifier for ERREMOTE as a string (equals to "ERREMOTE").
pub const ERREMOTE_ID: &str = "ERREMOTE";

/// Link has been severed.
pub const ENOLINK: std::os::raw::c_int = 82;
...
/// Advertise error.
pub const EADV: std::os::raw::c_int = 83;
...
/// Srmount error.
pub const ESRMNT: std::os::raw::c_int = 84;
...
pub const ECOMM: std::os::raw::c_int = 85;
...
/// Protocol error.
pub const EPROTO: std::os::raw::c_int = 86;
...
/// Multihop attempted.
pub const EMULTIHOP: std::os::raw::c_int = 87;
...
/// RFS specific error.
pub const EDOTDOT: std::os::raw::c_int = 88;
...
pub const EREMCHG: std::os::raw::c_int = 89;
...
pub const ENOSYS: std::os::raw::c_int = 90;
...
/// Streams pipe error.
pub const ESTRPIPE: std::os::raw::c_int = 91;
...
pub const EOVERFLOW: std::os::raw::c_int = 92;
...
pub const EBADFD: std::os::raw::c_int = 93;
...
pub const ECHRNG: std::os::raw::c_int = 94;
...
pub const EL2NSYNC: std::os::raw::c_int = 95;
...
/// Level 3 halted.
pub const EL3HLT: std::os::raw::c_int = 96;
...
/// Level 3 reset.
pub const EL3RST: std::os::raw::c_int = 97;
...
pub const ELNRNG: std::os::raw::c_int = 98;
...
pub const EUNATCH: std::os::raw::c_int = 99;
...
pub const ENOCSI: std::os::raw::c_int = 100;
...
/// Level 2 halted.
pub const EL2HLT: std::os::raw::c_int = 101;
...
/// Invalid exchange.
pub const EBADE: std::os::raw::c_int = 102;
...
pub const EBADR: std::os::raw::c_int = 103;
...
/// Exchange full.
pub const EXFULL: std::os::raw::c_int = 104;
...
/// No anode.
pub const ENOANO: std::os::raw::c_int = 105;
...
pub const EBADRQC: std::os::raw::c_int = 106;
...
/// Invalid slot.
pub const EBADSLT: std::os::raw::c_int = 107;
...
pub const EDEADLOCK: std::os::raw::c_int = 108;
/// Human-readable message for EDEADLOCK.
pub const EDEADLOCK_MSG: &str = "File locking deadlock error";
/// Identifier for EDEADLOCK as a string (equals to "EDEADLOCK").
pub const EDEADLOCK_ID: &str = "EDEADLOCK";

/// Bad font file format.
pub const EBFONT: std::os::raw::c_int = 109;
...
pub const ELIBEXEC: std::os::raw::c_int = 110;
...
/// No data available.
pub const ENODATA: std::os::raw::c_int = 111;
...
pub const ELIBBAD: std::os::raw::c_int = 112;
...
pub const ENOPKG: std::os::raw::c_int = 113;
...
pub const ELIBACC: std::os::raw::c_int = 114;
...
pub const ENOTUNIQ: std::os::raw::c_int = 115;
...
pub const ERESTART: std::os::raw::c_int = 116;
/// Human-readable message for ERESTART.
pub const ERESTART_MSG: &str = "Interrupted syscall should be restarted";
...
pub const EILSEQ: std::os::raw::c_int = 122;
...
pub const ELIBMAX: std::os::raw::c_int = 123;
/// Human-readable message for ELIBMAX.
pub const ELIBMAX_MSG: &str = "Atmpt to link in too many shared libs";
/// Identifier for ELIBMAX as a string (equals to "ELIBMAX").
pub const ELIBMAX_ID: &str = "ELIBMAX";

/// .lib section in a.out corrupted.
pub const ELIBSCN: std::os::raw::c_int = 124;
...
/// No medium found.
pub const ENOMEDIUM: std::os::raw::c_int = 125;
...
/// Wrong medium type.
pub const EMEDIUMTYPE: std::os::raw::c_int = 126;
...
/// Key has expired.
pub const EKEYEXPIRED: std::os::raw::c_int = 129;
...
pub const EKEYREVOKED: std::os::raw::c_int = 130;
...
pub const EKEYREJECTED: std::os::raw::c_int = 131;
...
/// Owner died.
pub const EOWNERDEAD: std::os::raw::c_int = 132;
...
pub const ENOTRECOVERABLE: std::os::raw::c_int = 133;
...
pub const ERFKILL: std::os::raw::c_int = 134;
...
pub const EHWPOISON: std::os::raw::c_int = 135;
...
include!(concat!(env!("OUT_DIR"), "/unix.linux.sparc.rs"));
