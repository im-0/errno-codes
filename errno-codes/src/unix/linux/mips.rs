...
/// Invalid exchange.
pub const EBADE: std::os::raw::c_int = 50;
...
pub const EBADR: std::os::raw::c_int = 51;
...
/// Exchange full.
pub const EXFULL: std::os::raw::c_int = 52;
...
/// No anode.
pub const ENOANO: std::os::raw::c_int = 53;
...
pub const EBADRQC: std::os::raw::c_int = 54;
...
/// Invalid slot.
pub const EBADSLT: std::os::raw::c_int = 55;
...
pub const EDEADLOCK: std::os::raw::c_int = 56;
...
/// Multihop attempted.
pub const EMULTIHOP: std::os::raw::c_int = 74;
...
/// Not a data message.
pub const EBADMSG: std::os::raw::c_int = 77;
...
/// File name too long.
pub const ENAMETOOLONG: std::os::raw::c_int = 78;
...
pub const EOVERFLOW: std::os::raw::c_int = 79;
...
pub const ENOTUNIQ: std::os::raw::c_int = 80;
...
pub const EBADFD: std::os::raw::c_int = 81;
...
pub const EREMCHG: std::os::raw::c_int = 82;
...
pub const ELIBACC: std::os::raw::c_int = 83;
...
pub const ELIBBAD: std::os::raw::c_int = 84;
...
pub const ELIBSCN: std::os::raw::c_int = 85;
...
pub const ELIBMAX: std::os::raw::c_int = 86;
...
pub const ELIBEXEC: std::os::raw::c_int = 87;
...
pub const EILSEQ: std::os::raw::c_int = 88;
...
pub const ENOSYS: std::os::raw::c_int = 89;
...
pub const ELOOP: std::os::raw::c_int = 90;
...
pub const ERESTART: std::os::raw::c_int = 91;
...
/// Streams pipe error.
pub const ESTRPIPE: std::os::raw::c_int = 92;
...
/// Directory not empty.
pub const ENOTEMPTY: std::os::raw::c_int = 93;
...
/// Too many users.
pub const EUSERS: std::os::raw::c_int = 94;
...
pub const ENOTSOCK: std::os::raw::c_int = 95;
...
pub const EDESTADDRREQ: std::os::raw::c_int = 96;
...
/// Message too long.
pub const EMSGSIZE: std::os::raw::c_int = 97;
...
pub const EPROTOTYPE: std::os::raw::c_int = 98;
...
pub const ENOPROTOOPT: std::os::raw::c_int = 99;
...
pub const EPROTONOSUPPORT: std::os::raw::c_int = 120;
...
pub const ESOCKTNOSUPPORT: std::os::raw::c_int = 121;
...
pub const EOPNOTSUPP: std::os::raw::c_int = 122;
...
pub const EPFNOSUPPORT: std::os::raw::c_int = 123;
...
pub const EAFNOSUPPORT: std::os::raw::c_int = 124;
...
pub const EADDRINUSE: std::os::raw::c_int = 125;
...
pub const EADDRNOTAVAIL: std::os::raw::c_int = 126;
...
/// Network is down.
pub const ENETDOWN: std::os::raw::c_int = 127;
...
pub const ENETUNREACH: std::os::raw::c_int = 128;
...
pub const ENETRESET: std::os::raw::c_int = 129;
...
pub const ECONNABORTED: std::os::raw::c_int = 130;
...
pub const ECONNRESET: std::os::raw::c_int = 131;
...
pub const ENOBUFS: std::os::raw::c_int = 132;
...
pub const EISCONN: std::os::raw::c_int = 133;
...
pub const ENOTCONN: std::os::raw::c_int = 134;
...
pub const EUCLEAN: std::os::raw::c_int = 135;
...
pub const ENOTNAM: std::os::raw::c_int = 137;
...
pub const ENAVAIL: std::os::raw::c_int = 138;
...
pub const EISNAM: std::os::raw::c_int = 139;
...
/// Remote I/O error.
pub const EREMOTEIO: std::os::raw::c_int = 140;
...
/// Reserved.
pub const EINIT: std::os::raw::c_int = 141;
/// Human-readable message for EINIT.
pub const EINIT_MSG: &str = "Reserved";
/// Identifier for EINIT as a string (equals to "EINIT").
pub const EINIT_ID: &str = "EINIT";

/// Error 142.
pub const EREMDEV: std::os::raw::c_int = 142;
/// Human-readable message for EREMDEV.
pub const EREMDEV_MSG: &str = "Error 142";
/// Identifier for EREMDEV as a string (equals to "EREMDEV").
pub const EREMDEV_ID: &str = "EREMDEV";

/// Cannot send after transport endpoint shutdown.
pub const ESHUTDOWN: std::os::raw::c_int = 143;
...
pub const ETOOMANYREFS: std::os::raw::c_int = 144;
...
pub const ETIMEDOUT: std::os::raw::c_int = 145;
...
/// Connection refused.
pub const ECONNREFUSED: std::os::raw::c_int = 146;
...
/// Host is down.
pub const EHOSTDOWN: std::os::raw::c_int = 147;
...
/// No route to host.
pub const EHOSTUNREACH: std::os::raw::c_int = 148;
...
pub const EALREADY: std::os::raw::c_int = 149;
...
pub const EINPROGRESS: std::os::raw::c_int = 150;
...
/// Stale file handle.
pub const ESTALE: std::os::raw::c_int = 151;
...
pub const ECANCELED: std::os::raw::c_int = 158;
/// Human-readable message for ECANCELED.
pub const ECANCELED_MSG: &str = "AIO operation canceled";
/// Identifier for ECANCELED as a string (equals to "ECANCELED").
pub const ECANCELED_ID: &str = "ECANCELED";

/// No medium found.
pub const ENOMEDIUM: std::os::raw::c_int = 159;
...
/// Wrong medium type.
pub const EMEDIUMTYPE: std::os::raw::c_int = 160;
...
pub const ENOKEY: std::os::raw::c_int = 161;
...
/// Key has expired.
pub const EKEYEXPIRED: std::os::raw::c_int = 162;
...
pub const EKEYREVOKED: std::os::raw::c_int = 163;
...
pub const EKEYREJECTED: std::os::raw::c_int = 164;
...
/// Owner died.
pub const EOWNERDEAD: std::os::raw::c_int = 165;
...
pub const ENOTRECOVERABLE: std::os::raw::c_int = 166;
...
pub const ERFKILL: std::os::raw::c_int = 167;
...
pub const EHWPOISON: std::os::raw::c_int = 168;
...
/// Quota exceeded.
pub const EDQUOT: std::os::raw::c_int = 1133;
